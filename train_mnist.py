...
if __name__=='__main__':
  ...
  parser.add_argument('--epochs', type=int, default = 10, help='experiment name')
  parser.add_argument('--batch_size', type=int, default = 128, help='experiment name')
  parser.add_argument('--lr', type=float, default = 1e-3, help='experiment name')
